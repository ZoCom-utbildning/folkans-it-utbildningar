    ...
    const courses = courseData.map((course, index) => {
        return(
            <section className="course" key={index}>
                <h3 className="smallerH3">{course.name}</h3>
                <p>{course.location}</p>
            </section>
        );
    });
    ...
    return (
        <div className="aboutView">
            ...
            <form className="contactForm">
                <h3 className="smallerText">Kontakta oss direkt</h3>
            ...
            <h2 className="smallerH2">Innehåll</h2>
            ...
            <section className="coursesWrapper line">
                <h2 className="smallerH2">Våra utbildningar</h2>
                {courses}
            </section>
        </div>
    );
