                      ...
                      <article className="personas-card">
                        ...
                        <main className="personas-card-text-container">
                          <p className="personas-card-ingress">
                            Adam är en av de personer som startat sin utbildning
                            hos Folkuniversitetet.
                          </p>
                          <p className="personas-card-text">
                            Här är en text som beskriver Adam och hur han kom in
                            på utbildningensom förändrade hans liv till det
                            ...
                            hemsida, efter att han tagit quizet och fått reda på
                            att han skulle passa perfekt inom
            ...
            >
              <div className="el__overflow">
                <div className="el__inner">
                  <div className="el__bg"></div>
                  <section className="el__preview-cont">
                    <h2 className="el__heading">Bertil, 30</h2>
                  </section>
                  <div className="el__content">
            ...
            >
              <div className="el__overflow">
                <div className="el__inner">
                  <div className="el__bg"></div>
                  <section className="el__preview-cont">
                    <h2 className="el__heading">Ahmed, 32</h2>
                  </section>
                  <div className="el__content">
                    <div className="el__text">Whatever</div>
                    <div
            ...
            >
              <div className="el__overflow">
                <div className="el__inner">
                  <div className="el__bg"></div>
                  <section className="el__preview-cont">
                    <h2 className="el__heading">Anja, 23</h2>
                  </section>
                  <div className="el__content">
                    <div className="el__text">Whatever</div>
                    <div
            ...
            >
              <div className="el__overflow">
                <div className="el__inner">
                  <div className="el__bg"></div>
                  <section className="el__preview-cont">
                    <h2 className="el__heading">Amina, 38</h2>
                  </section>
                  <div className="el__content">
                    <div className="el__text">Whatever</div>
                    <div
              ...
              <div className="el__index">
                ...
                <div className="el__index-front">
                  <div className="el__index-overlay" data-index="5">
                    5
                  </div>
                </div>
              </div>
