  ...
  return (
    <section className='results_list'>
      <section key={index} className='results_item'>
        ...
        <span onClick={() => setToggleInfo(!toggleInfo)}>
          {courseScore.course}
          <span className='study_at'>
            {courseScore.studyAt}
            {toggleInfo ? (
        ...
        <button
          ...
          onClick={() => openNewTab(`/utbildningar/${courseScore.intLink}`)}
        >
          {' '}
          Läs mer{' '}
        </button>
      ...
      {toggleInfo ? (
        <section className='toggleText'>
          ...
          <a
            ...
            onClick={() => openNewTab(courseScore.links.link)}
          >
            {' '}
            Ansök här{' '}
          </a>
